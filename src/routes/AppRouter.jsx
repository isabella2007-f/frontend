      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute allowedRoles={["administrador"]} />}>
          <Route element={<MainLayout />}>
            ...
            <Route path="/admin/inicio" element={<LandingPage hideNavbar={true} />} />
            <Route path="/admin/usuarios" element={<GestionUsuarios />} />
            <Route path="/admin/empleados" element={<Empleados />} />
            <Route path="/admin/roles" element={<Roles />} />
            <Route path="/admin/control-acceso" element={<AccessManagement />} />

            <Route path="/admin/categorias_productos" element={<CategoriaProductos />} />
            <Route path="/admin/products" element={<Productos />} />

            <Route path="/admin/clientes" element={<GestionClientes />} />

            <Route path="/admin/categorias_insumos" element={<CategoriaInsumos />} />
            <Route path="/admin/gestion-insumos" element={<GestionInsumos />} />
