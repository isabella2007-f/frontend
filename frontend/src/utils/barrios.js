...
export const BARRIOS_POR_MUNICIPIO = {
  'Medellín': [
    ...
    'San Antonio de Prado', 'San Cristóbal', 'Santa Elena',
    'San Sebastián de Palmitas', 'Barrio Colombia', 'Ciudad del Río',
    'San Lucas', 'Los Naranjos', 'Trece de Noviembre', 'El Corazón',
    'Olaya Herrera', 'Santa Margarita', 'El Diamante', 'La Gloria',
    'Las Independencias', 'Villa Liliam', 'La Iguaná', 'El Salvador',
    'El Pinal', 'Ocho de Marzo', 'Juan Pablo II',
    'Otro (escribirlo)',
  ],
  'Bello': [
    ...
    'Congolo', 'La Milagrosa', 'Amazonía', 'Central',
    'La Gabriela', 'El Cairo', 'Santa Rita', 'Buenos Aires', 'La Primavera',
    'Hato Viejo', 'El Mirador', 'Espíritu Santo', 'Altos de Niquía',
    'Otro (escribirlo)',
  ],
  'Itagüí': [
    ...
    'Centro', 'Santa Ana', 'El Palmar',
    'El Progreso', 'Los Gómez', 'El Tablazo', 'Santa Catalina', 'San José',
    'Terranova', 'Malta', 'La María',
    'Otro (escribirlo)',
  ],
  'Envigado': [
    ...
    'San Rafael',
    'El Portal', 'El Trianón', 'El Esmeraldal', 'Loma de las Brujas',
    'Las Flores', 'La Mina', 'Villagrande', 'Alto de Misael', 'La Sebastiana',
    'Otro (escribirlo)',
  ],
  'Sabaneta': [
    ...
    'Santa Ana', 'Promisión', 'Cañaveralejo', 'Pan de Azúcar', 'Los Alcázares',
    'San José',
    'Otro (escribirlo)',
  ],
  'La Estrella': [
    ...
    'Tablacita',
    'Pueblo Viejo', 'La Ferrería', 'Caruquia', 'Peñas Blancas', 'Tarapacá',
    'La Bermejala',
    'Otro (escribirlo)',
  ],
  'Caldas': [
    ...
    'Cristo Rey', 'Fundadores', 'Los Cerezos',
    'La Rivera', 'La Playita', 'Centenario', 'Salinas',
    'Otro (escribirlo)',
  ],
  'Copacabana': [
    'Centro', 'El Recreo', 'Fátima', 'La Azulita', 'La Misericordia',
    'Las Vegas', 'Machado', 'María', 'Pedregal', 'San Juan', 'Villanueva',
    'Zarzal', 'El Pedregal', 'Tobón Quintero', 'Ancón',
    'El Convento', 'La Asunción', 'San Francisco',
    'Otro (escribirlo)',
  ],
  'Girardota': [
