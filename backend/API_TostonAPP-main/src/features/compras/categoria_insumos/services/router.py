...
def listar_categorias(
    ...
    _:          dict          = Depends(requiere_permiso("ver_cat_insumos"))
):
...
def agregar_categoria(
    ...
    db:    Session = Depends(get_db),
    _:     dict    = Depends(requiere_permiso("crear_cat_insumos"))
):
...
def actualizar_categoria(
    ...
    db:           Session = Depends(get_db),
    _:            dict    = Depends(requiere_permiso("editar_cat_insumos"))
):
...
def borrar_categoria(
    id_categoria: int,
    db:           Session = Depends(get_db),
    _:            dict    = Depends(requiere_permiso("eliminar_cat_insumos"))
):
